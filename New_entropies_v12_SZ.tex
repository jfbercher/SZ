...
\item[Example~2]   The  $q$-Gaussian   distribution,  also   known   as  Tsallis
  ...
  $C_q$ is  the normalizacion coefficient, defined  over $\X =  \Rset$, with the
...
\item[Example~3-1] The arcsince distribution,  $f_X(x) = \frac{1}{\pi \sqrt{2 \,
  ...
  +  \gamma \quad  \mbox{with} \quad  \alpha_\pm >  0$$ (see  appendix  for more
  details).
%
\item[Example~3-1]  This  arcsince distribution,  now  constraint uniformely  by
