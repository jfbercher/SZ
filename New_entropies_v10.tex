...
\SZ{Since the  pionner works  Boltzmann, Maxwell, Planck  and Gibbs~\cite{Bol64,
    Pla15,   Nie52:v2,    Jay65,   MulMul09},   von    Neuman~\cite{vNeu27}   or
...
\SZ{As stated in the introdution,  two inverse problems can be considered started
  ...
  \&  Kapur  in~\cite{KesKap89}, although  formalized  in  the discrete  Shannon
  framework.
...
\item\label{MonotonyDomains:cond}   $f(x)$   and   $\displaystyle   \sum_{i=1}^n
  \lambda_i   \,  T_i(x)$  must   have  \Avoir{the   same  sense   of  variations},
