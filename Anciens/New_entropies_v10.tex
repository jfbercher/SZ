...
papers~\cite{Ham78,   ChimPen00,    CasChi02,   LutYan05,   LutLv12,   JohVig07,
  Ber12:06_1,  Ber12:06_2,  Ber13}.   In   what  follows,  we  generalize  these
definition  a step  further in  our $\phi$-entropy  context by  using  the above
defined $\phi$-escort distribution.
...
intensively studied  in~\cite{Ber13:08} \SZ{(see also~\cite{JohVig07})}.  \SZ{In
  such a case, the nonlinear equation is known as the $p$-Laplacian equation and
  appears  in   physics  as  description   of  flows  in   (generalized)  porous
  medium~\cite{Vaz06}. In  the general case, this  kind of equation  can also be
  viewed  as  a  generalization of  the  porous  medium  equation, of  the  fast
  diffusion equation, or of the nonlinear Fokker-Planck equation that appears in
  flow in  porous medium, nonlinear  heat transfer, population  dynamics, Plasma
  radiation, etc~\cite{New84, Vaz06, Vaz07, Fra05}
...
\SZ{As pointed  out before, in the  scalar context $m=1$ for  the parameter, for
  ...
  extensions  proposed in~\cite{JohVig07,  Ber13:08, Guo09,  TorZoz16_arxiv} are
